...
// const Chalk = (str: any, color: string): string => {
//   return (`%c ${str}`, `color: ${color}; font-weight: bold;`);
// };
const blue = (str) => {
...
function logger(req: Request, res: Response, next: NextFunction) {
	...
	res.once('finish', () => {
		...
		console.log(`${idText}${timeStampText} ${method}:${Chalk('BgWhite',url)} ${res.statusCode} ${endText}`);
	});
